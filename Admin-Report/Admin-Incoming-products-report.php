...
<head>
    ...
    <link rel="stylesheet" href="../CSS/admin-incoming-products-report.css">
...
<body>
    <div id="mySidebar" class="sidebar">
        ...
        <a href="#">Help</a>
        <a href="Admin-Incoming-products-report.php?logout=<?php echo "$username"?>">Logout</a>
    </div>
    <div id="main">
        <button class="openbtn" onclick="openNav()">&#9776; Open Menu</button>
        <div class="container">
        <h1 class="incoming-products-report-header">Incoming Products Report</h1>
            <div class="print-btn-div">
                <a href="incoming-product-report-pdf.php" target="_blank" class="print-btn">Print PDF</a>
            </div>
            <table>
                <thead>
                    <th>Date</th>
