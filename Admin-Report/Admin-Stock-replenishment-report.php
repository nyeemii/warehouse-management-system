...
<body>
    <div id="mySidebar" class="sidebar">
        ...
        <div class="dropdown-container">
            ...
            <a href="Admin-Stock-replenishment-report.php" style="color: #51c4d3">Stock Replenishment Report</a>
        ...
        <a href="#">Help</a>
        <a href="Admin-Stock-replenishment-report.php?logout=<?php echo "$username"?>">Logout</a>
    </div>
    <div id="main">
        ...
        <div class="container">
            ...
            <div class="print-btn-div">
                <a href="Stock-replenishment-report-pdf.php" target="_blank" class="print-btn">Print PDF</a>
            </div>
            <table>
                <thead>
                    <th>roductP ID</th>
                ...
                <tbody>
                    <?php
                        $sql = "SELECT * FROM tbl_product WHERE quantity <= 10";
                        $result = $db->query($sql);
