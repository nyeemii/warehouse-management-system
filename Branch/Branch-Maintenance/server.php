<?php
    ...
    if (isset($_POST['btn_edit1'])) {
        ...
        $sql = "SELECT brandName FROM tbl_product_store WHERE brandName='$brand' AND model='$model'";
        $result = $db->query($sql);
        if ($result->num_rows === 0) {
            ?>
                <div class="alert">
            ...
            $query = "UPDATE tbl_product_store SET price = '$price' WHERE brandName='$brand' AND model='$model'";
            mysqli_query($db, $query);
